...
- Ryu SDN controller — installed inside a Python 3.8 virtual environment (see note below)
...
## Files
- `topologies/chain_topo.py` — example chain topology from Part 2.2 of the lab sheet (learning the pattern)
- `topologies/my_chain_topo.py` — original three-switch chain topology built for Exercise 3, using a distinct IP scheme (`192.168.1.x/24`)
- `exercise_answers.md` — written answers for Exercises 2, 5, and 6, plus a summary of what was done for all six exercises
